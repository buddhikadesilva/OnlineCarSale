...
This is a php web application , that demonstrate a shopping curt. Used Technologies are PHP , MYSQL . If you insteresd you can use it . please make sure to click a star for this repo. Thank you.
